    ...
    $result= $con->query("SELECT * FROM sign_up_general WHERE email='$email';");
      ...
      if($num != 0 && $result == true){
        echo 'email_exists';
          ...
          $result = $con->query("INSERT INTO sign_up_general VALUES(NULL, '$user_id', '$user', '$email', '$password', '$phone','$b_date','0','$caddress','0', '$gender','0','0','user.png','background.jpg','user','0');");
          if ($result == true) {
            echo 'success';
          }else {
            echo 'faild';
