...
<main class="main">
 <section class="filters container">
  ...
  <div class="filters__sections">
   ...
   <!-- service -->
   <div class="container-fluid pt-6 filter" data-content id="service">
    <div class="container">
     ...
     <div class="row pb-4">
      <div class="service-box col-lg-4 col-md-6 text-center mb-5">
       <div class="d-flex align-items-center justify-content-center mb-4" style="flex-direction: column; row-gap:10px;">
      ...
      <div class="service-box col-lg-4 col-md-6 text-center mb-5">
       <div class="d-flex align-items-center justify-content-center mb-4" style="flex-direction: column; row-gap:15px;">
        <div class="top" style="display: flex; align-items:center;justify-content:center;">
